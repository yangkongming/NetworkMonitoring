...
import static www.pdx.life.networkmonitoring.httpdebug.floatwindow.Rom.isIntentAvailable;
...
class MiuiMeizu {
    private static final String TAG = "MiuiMeizu";
    ...
    static boolean rom() {
        Log.e(TAG, " MiuiMeizu  : " + MiuiMeizu.getProp());
