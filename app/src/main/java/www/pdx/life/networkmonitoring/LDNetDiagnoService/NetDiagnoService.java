package www.pdx.life.networkmonitoring.LDNetDiagnoService;
...
import www.pdx.life.networkmonitoring.LDNetDiagnoUtils.LDNetUtil;
import www.pdx.life.networkmonitoring.util.AppUtils;
import www.pdx.life.networkmonitoring.util.UserInfo;
...
public class NetDiagnoService extends
    ...
    protected void onPostExecute(String result) {
        ...
        // 线程执行结束
        recordStepInfo("\n网络诊断结束：" + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()));
    ...
    public String startNetDiagnosis() {
        ...
        recordStepInfo("用户ID：" + new UserInfo().userId);
        recordStepInfo("开始诊断：" + new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()));

        Observable.create(new ObservableOnSubscribe<Object>() {
            @Override
            public void subscribe(ObservableEmitter<Object> e) throws Exception {
                recordStepInfo("\n外网IP：" + LDNetUtil.GetNetIp());
            }
...
//      }
     ...
     * @param stepInfo
     */
    private synchronized void recordStepInfo(String stepInfo) {
    ...
    private void recordCurrentAppVersion() {
        ...
        recordStepInfo("UA:\t" + new UserInfo().userAgent);
        recordStepInfo("系统版本:\t" + android.os.Build.VERSION.RELEASE);
        recordStepInfo("APP名称:\t" + AppUtils.getAppName(_context));
        recordStepInfo("APP包名:\t" + AppUtils.getPackageName(_context));
        recordStepInfo("APP版本:\t" + AppUtils.getVersionName(_context));
